<%@ Page Language="C#" AutoEventWireup="true" CodeFile="info-consecutive.aspx.cs" Inherits="info_consecutive" %>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="list-consecutives.aspx">Consecutivos</a></li>
                                <li class="breadcrumb-item active">Edita Consecutivo</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7">
                        <div class="checkout_details_area clearfix">
                            <h5>Informacion del Consecutivo</h5>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="descConsecutivo">Descripcion:</label>
                                ...
                                <div class="col-md-3 mb-4 input-group">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="email">Rango Inicial:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="email">Rango Final:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
