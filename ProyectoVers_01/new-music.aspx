<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new-music.aspx.cs" Inherits="new_music" %>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="list-music.aspx">Musica</a></li>
                        ...
                        <div class="checkout_details_area clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    <label for="email">Disquera:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
