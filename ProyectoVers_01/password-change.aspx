...
<head runat="server">
    ...
    <!-- Title -->
    <title>Cambiar Contrasenha</title>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Cambiar Contrasenha</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7">
                        <div class="checkout_details_area clearfix">
                            <h5>Nueva Contrasenha</h5>
                            <div class="row">
                                <div class="col-12 mb-4">
                                    <label for="actual_password">Contrasenha Actual *</label>
                                    <input type="email" class="form-control" id="actual_password" value=""/>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="new_password">Nueva Contrasenha *</label>
                                    <input type="text" class="form-control" id="new_password" value="" required="required"/>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="confirm_password">Confirmar Contrasenha *</label>
                                    <input type="text" class="form-control" id="confirm_password" value="" required="required"/>
                                </div>
                                <div class="col-md-6 mb-4"></div>
                                <div class="password-change-btn col-12 mb-4">
                                    <a href="#" class="btn alazea-btn w-100">Confirmar</a>
                                </div>
                            </div>
                        </div>
                    </div>
