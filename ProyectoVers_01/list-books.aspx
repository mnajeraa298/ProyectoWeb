<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list-books.aspx.cs" Inherits="list_books" %>
                        ...
                        <div class="checkout_details_area clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>Libro</td>
                                            <td>
                                                <a href="edit-book.aspx">Editar</a>
                                            </td>
                                            <td>
                                                <a href="#">Eliminar</a>
                                            </td>
                                ...
                                <div class="col-md-6 mb-4 create_user-btn">
                                    <a href="new-book.aspx" class="btn alazea-btn w-100">Nuevo</a>
                                </div>
                            </div>
                        </div>
                    </div>
