<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list-music.aspx.cs" Inherits="list_music" %>
                        ...
                        <div class="checkout_details_area clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>Cancion</td>
                                            <td>
                                                <a href="edit-music.aspx">Editar</a>
                                            </td>
                                            <td>
                                                <a href="#">Eliminar</a>
                                            </td>
                                ...
                                <div class="col-md-6 mb-4 create_user-btn">
                                    <a href="new-music.aspx" class="btn alazea-btn w-100">Nuevo</a>
                                </div>
                            </div>
                        </div>
                    </div>
