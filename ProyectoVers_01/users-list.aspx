<%@ Page Language="C#" AutoEventWireup="true" CodeFile="users-list.aspx.cs" Inherits="users_list" %>
                        ...
                        <div class="blog-posts-area">
                            ...
                            <div class="single-post-details-area">
                                <div class="post-content">
                                    <h4 class="post-title">Todos los Usuarios</h4>
                                    <blockquote>
                        ...
                        <div class="post-sidebar-area">
                            ...
                            <div class="single-widget-area">
                                ...
                                <div class="author-widget">
                                    <div class="author-thumb-name align-items-center">
                                        <p><input type="radio" name="user_status" id="" onclick=""/>   Activo<br/></p>
                                        <p><input type="radio" name="user_status" id="" onclick=""/>   Inactivo<br/></p>
                                    </div>
                                    <!-- Single Checkbox -->
                                    ...
                                    <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                                        ...
                                        <label class="custom-control-label" for="customCheck3">Mantenimiento</label>
                                    </div>
                                    <!-- Single Checkbox -->
                                    <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                                        <input type="checkbox" class="custom-control-input" id="customCheck4"/>
                                        <label class="custom-control-label" for="customCheck4">Consultas</label>
                                    </div>
                                    <div class="col-12">    
                                        <br/>
                                        <a href="#" class="btn alazea-btn w-100">Actualizar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
