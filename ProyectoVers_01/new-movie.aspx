<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new-movie.aspx.cs" Inherits="new_movie" %>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="list-movie.aspx">Peliculas</a></li>
                                <li class="breadcrumb-item active">Nueva Pelicula</li>
                            </ol>
                        </nav>
                    </div>
                </div>
