<%@ Page Language="C#" AutoEventWireup="true" CodeFile="parameters-paths.aspx.cs" Inherits="parameters_paths" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7">
                        <div class="checkout_details_area clearfix">
                            <h5>Informacion de Rutas Parametros</h5>
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <label for="email">Pre-visualizacion Peliculas:</label>
                                    <input type="text" class="form-control" id="email" value=""/>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label for="email">Almacenamieto Peliculas:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label for="email">Pre-visualizacion Musica:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label for="email">Almacenamiento Musica:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label for="email">Pre-visualizacion Libros PDF:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label for="email">Almacenamiento Libros PDF:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
