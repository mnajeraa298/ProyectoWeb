<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list-consecutives.aspx.cs" Inherits="list_consecutives" %>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Consecutivos</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="checkout_details_area clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>1</td>
                                            <td>
                                                <a href="info-consecutive.aspx">Editar</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                ...
                                <div class="col-md-6 mb-4 create_user-btn">
                                    <a href="info-consecutive.aspx" class="btn alazea-btn w-100">Nuevo</a>
                                </div>
                            </div>
                        </div>
                    </div>
