<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new-book.aspx.cs" Inherits="new_book" %>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="list-books.aspx">Libros</a></li>
                    ...
                    <div class="col-12 col-lg-7">
                        <div class="checkout_details_area clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    <label for="email">Anho de Publicacion:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                <div class="col-md-4 mb-4">
                                ...
                                <div class="input-group col-md-12 form-group">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="actoresFromControl">Autores</label>
                                    </div>
                                ...
                                <div class="col-md-12 mb-4">
                                    <label for="email">Archivo Descarga Actual:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                ...
                                <div class="col-md-12 mb-4">
                                    <label for="email">Archivo Pre-Visualizacion Actual:</label>
                                    <input type="text" class="form-control" value=""/>
                                </div>
                                <div class="input-group col-md-12 mb-4">
                                    <div class="input-group-prepend">
